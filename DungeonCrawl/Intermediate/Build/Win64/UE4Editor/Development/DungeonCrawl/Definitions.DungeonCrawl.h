#undef DUNGEONCRAWL_API
#undef DUNGEONCRAWL_VTABLE
...
#define UE_PROJECT_NAME DungeonCrawl
...
#define DUNGEONCRAWL_VTABLE DLLEXPORT_VTABLE
#define DUNGEONCRAWL_API DLLEXPORT
